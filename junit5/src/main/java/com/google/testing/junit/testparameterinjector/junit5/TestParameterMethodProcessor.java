...
class TestParameterMethodProcessor implements TestMethodProcessor {
  ...
  private static Class<? extends TestParameterValuesProvider> valuesProvider(
    ...
    // @com.google.testing.junit.testparameterinjector.junit5.TestParameter(value=[], valuesProvider=class
    // com.google.testing.junit.testparameterinjector.junit5.TestParameterValuesProvider$DefaultTestParameterValuesProvider)
